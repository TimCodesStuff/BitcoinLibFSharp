...
type BitcoinAddressTests () =
    ...
    member this.TestGenerateBitcoinAddressRecordFromHex () =
        BitcoinAddress.GenerateBitcoinAddressRecordFromPrivateKeyHex true "18e14a7b6a307f426a94f8114701e7c8e774e7f9a47e2c2035db29a206321725"
        |> function
    ...
    member this.TestGenerateBitcoinAddressRecordFromWif () =
        BitcoinAddress.GenerateBitcoinAddressRecordFromPrivateKeyWIF true "Kx45GeUBSMPReYQwgXiKhG9FzNXrnCeutJp4yjTd5kKxCitadm3C"
        |> function
        | Error m -> Assert.Fail m
        | Ok address -> 
    ...
    [<TestMethod>]
     member this.TestP2PKHAddressGeneration () =
        BitcoinAddress.GenerateBitcoinAddressRecordFromPrivateKeyHex true "60cf347dbc59d31c1358c8e5cf5e45b822ab85b79cb32a9f3d98184779a9efc2"
        |> function
        | Error m -> Assert.Fail m
        | Ok address -> 
    ...
    [<TestMethod>]
     member this.TestP2SHAddressGeneration () =
        BitcoinAddress.GenerateBitcoinAddressRecordFromPrivateKeyHex true "a966eb6058f8ec9f47074a2faadd3dab42e2c60ed05bc34d39d6c0e1d32b8bdf"
        |> function
        | Error m -> Assert.Fail m
        | Ok address -> 
